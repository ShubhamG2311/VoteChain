...
function CandidateImageRegister() {
            ...
            const face1 = await faceapi.detectSingleFace(img1,
              ...
              // Using Euclidean distance to compare face descriptions
                  ...
                  if (distance < 0.5) {
                    ...
                    await election.setCandidateIpfsHash(accounts[0],response1.data.IpfsHash, response2.data.IpfsHash);

                    setLoading(false);

                    // await election.setCandidateFace(accounts[0]);
...
export default CandidateImageRegister;
